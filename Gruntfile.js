...
/*
 * Provides tasks for building and testing the "asteria-eos" project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "asteria-eos" project:
  grunt.registerTask('build', ['ts:build', 'copy:main',
                               'copy:initTypes', 'copy:buildTypesFile',
                               'clean:build']);

  //--> Task: builds the "asteria-eos" API documentation:
